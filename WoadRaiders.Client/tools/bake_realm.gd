...
# instanced kit props — a sarcophagus blocks because it is one, unless the
# author says otherwise with the no_collide group (node + subtree; the bake
# prints what it drops). What holds a
