...
public sealed class LocalPlayer
{
    ...
    private IRealmGeometry? _geometry; // cursor rays land on this terrain
    ...
    public void BeginSession(int playerId, SysVec3 spawn, IRealmGeometry? geometry, CharacterClass cls)
    {
        PlayerId = playerId;
        _geometry = geometry;
